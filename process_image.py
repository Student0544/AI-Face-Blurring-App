...
input_folder1 = r"path_to_training_dataset_here"
input_folder2 = r"path_to_segmented_dataset_here"
new_height = 300
new_width = 300
brighten_factor = 15
contrast_factor = 1
...
# the segmented images (this applies for the images from the CCIHP training and segmented dataset)
