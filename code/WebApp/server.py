...
home_screen = "This censor app was built using a retrained Faster RCNN from Pytorch, and it targets human faces and glasses to censor. Colored images with no filters work best, and videos take a long time to process (few seconds per frame)."
